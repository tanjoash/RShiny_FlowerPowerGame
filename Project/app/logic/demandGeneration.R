...
forecastB1 <- list(2, 3, 3, 2, 2, 3, 3, 5, 4, 5,	6, 7, 6, 7, 6, 8, 9, 9, 10, 11, 10, 10, 10, 11, 10, 14,	13, 12, 14, 13, 15)
forecastB2 <- list(1, 2, 1, 2, 1, 3, 2, 3, 2, 4,	3, 4, 3, 4, 5, 5, 5, 6, 5, 7,	6, 5, 8, 7, 10, 8, 6, 9, 7, 9, 11)
forecastB3 <- list(2, 3, 3, 4, 4, 4, 4, 5, 4, 7, 5, 5, 6, 6, 6, 5, 8, 8, 8, 9, 9, 10, 11, 12, 14, 14, 13, 13, 15, 16, 14)
forecastB4 <- list(2, 3, 3, 3, 3, 4, 4, 6, 5, 6, 7, 7, 8, 8, 8, 9, 8, 8, 8, 9, 9, 10, 11, 10, 11, 11, 12,	12, 15, 14, 15)
forecastB5 <- list(2, 1, 2, 3, 2, 2, 5, 3, 5, 3,	4, 5, 6, 5, 4, 5, 5, 7, 6, 8,	5, 4, 8, 7, 7, 5, 6, 9, 8, 10, 8)
forecastB6 <- list(2, 3, 4, 2, 3, 4, 5, 4, 6, 5,	7, 8, 9, 10, 11, 10, 11, 12, 11, 12, 11, 12, 12, 10, 14, 15, 16, 16, 17, 18, 16)
